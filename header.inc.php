...
<header class="class_2" >
	...
	<div  class="item_class_0 class_5">
		...
		<div  class="item_class_2 class_7">
			<a href="index.php" class="class_8" style="background-color: hwb(184 2% 66% / 0.287);">
				Forum
			</a>
			<a href="#" class="class_8" style="background-color: hwb(147 6% 42% / 0.287);">
				A propos de nous!
			</a>
			<a href="#" class="class_8" style="background-color: rgb(223, 159, 40);"  >
				Nous Contact !
			</a>
	...
	<div class="class_9" style="display:flex;align-items: center;justify-content: center;"  >
		...
		<?php else:?>
			<span style="cursor:pointer;" onclick="login.show()">Connexion</span>
		<?php endif;?>
	</div>
</header>
<script>
