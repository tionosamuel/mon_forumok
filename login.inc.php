...
<div class="js-login-modal class_55 hide" >
	...
	<h1 class="class_27" style="color: lightseagreen;" >
		Connexion
	</h1>
	...
	<form onsubmit="login.submit(event)" method="post" class="class_57" >
		<div class="class_30" >
			...
			<div style="padding: 10px;">As-tu un compte? <span style="cursor:pointer;color:blue;" onclick="signup.show()">Cliquer ici pour vous inscrire</span></div>
			<div class="class_59" >
				<button class="class_60"  style="background-color: lightseagreen;">
					Connexion
				</button>
				<div class="class_40" >
				</div>
